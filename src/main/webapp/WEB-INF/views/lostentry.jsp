...
<body style="background-image: linear-gradient(to top,#5d817b,#d1dbcf);">
	...
	<div class="back-link">
		<h5><a href="/rssfeeds/viewFeeds" style="float:right;margin-right:50px;"> Dashboard</a><i style="float:right" class="material-icons">dashboard</i></h5>
	</div>
		<div class="formBox">
		<form:form method="POST" class="form-form" name="loginform" modelAttribute="entries" action="save">
