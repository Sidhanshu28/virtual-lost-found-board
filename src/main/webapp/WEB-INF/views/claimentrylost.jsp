...
<body style="background-image: linear-gradient(to top,#5d817b,#d1dbcf);">
	...
	<div class="back-link">
		...
		<div class="formBox">
		<form:form method="POST" class="form-form" name="entryform" modelAttribute="lost-claim-entries" action="submit-claim-lost/{$entries.lost_id}" onsubmit="return validate(event);">
