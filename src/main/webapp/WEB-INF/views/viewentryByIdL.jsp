	...
	<div class="back-link">
		...
		<table
			...
			<thead style="background:darkseagreen">
				<tr>
					<th colspan="4">Lost Entry Details</th>
				</tr>
				<tr>
					<th>Category</th>
					<th>Description</th>
		...
		Is it yours? <a href="../../claimentrylost/id=${list[0].id}"><button class="btn -btn-default">Claim</button></a>&nbsp;<a href="../../lostentrydelete/id=${list[0].id}"><button class="btn -btn-default">Delete</button></a>&nbsp;<a href="../../updatelost/id=${list[0].id}"><button class="btn -btn-default">Update</button></a>
