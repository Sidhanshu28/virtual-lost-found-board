...
<body style="background-image: linear-gradient(to top,#5d817b,#d1dbcf);">
	...
	<div class="back-link">
		...
		Is it yours? <a href="../../claimentryfound/id=${list[0].id}"><button class="btn -btn-default">Claim</button></a><a href="../../lostentrydelete/id=${list[0].id}"><button class="btn -btn-default">Delete</button></a>
